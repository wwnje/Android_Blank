...
public class FirstChooseTypeActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, BlankItemsBaseAdapter.OnItemClickListener, BlankItemsBaseAdapter.OnLongItemClickListener {

    private static final String TAG = "FirstChooseTypeActivity";
